    ...
    <header class="navbar navbar-expand-lg bg-body navbar-sticky sticky-top px-0">
        <div class="container-fluid mx-lg-5 flex-nowrap">
            ...
            <div class="d-flex gap-3 gap-sm-4 me-5">
                <div class="dropdown">
                    <div class="info" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown"
                        aria-expanded="false">
                        <img src="{{ asset('images/customer-images/user_profile.jpg') }}" alt="Customer Name"
                            class="img-fluid rounded-circle mx-2" style="width: 2vw">
                        <span>Inoc George Alfeser H</span>
                    </div>
            ...
            <div class="row">
                <div class="col-6 col-md-2 mb-3">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-muted">All Silver</a></li>
                        <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-muted">Best Seller</a></li>
                        <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-muted">Best Reviews</a></li>
                        <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-muted">Bracelets</a></li>
                ...
                <div class="col-6 col-md-2 mb-3">
                    ...
                    <ul class="nav flex-column">
                        ...
                        <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-muted">Terms & Services</a></li>
                        <li class="nav-item mb-2"><a href="#" class="nav-link p-0 text-muted">Terms & User</a></li>
